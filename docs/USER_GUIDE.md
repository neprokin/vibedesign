...
2. **Tool Selector** - панель выбора инструментов (анализ, генерация кода и т.д.)
3. **Tool Configuration** - настройки выбранного инструмента
4. **Action Area** - кнопки действий и дополнительные опции
5. **Results Panel** - область отображения результатов
